<form action="<?php echo base_url() . 'savedata/' . $id; ?>" method="post">
    <div class="container-fluid">
        ...
        <div class="row align-items-start">
            ...
            <input class="col" type="text" name="provinsi" id="provinsi" value="<?php echo $dataresult[0]->provinsi; ?>" required>
        ...
        <div class="row align-items-start">
            ...
            <input class="col" type="text" name="gender" id="gender" value="<?php echo $dataresult[0]->gender; ?>" required>
        </div>

        <div class="row align-items-start">
            <label class="col" for="alamat"><b>alamat</b></label>
            <input class="col" type="text" name="alamat" id="alamat" value="<?php echo $dataresult[0]->alamat; ?>" required>
        ...
        <div class="row align-items-start">
            ...
            <input class="col" type="text" name="agama" id="agama" value="<?php echo $dataresult[0]->agama; ?>" required>
            <label class="col" for="sts_kawin"><b>sts_kawin</b></label>
            <input class="col" type="text" name="sts_kawin" id="sts_kawin" value="<?php echo $dataresult[0]->sts_kawin; ?>" required>
        </div>
        ...
        <div class="row align-items-start">
            ...
            <input class="col" type="text" name="nation" id="nation" value="<?php echo $dataresult[0]->nation; ?>" required>
        ...
        <div class="row align-items-start">
            ...
            <input class="col" type="text" name="goldar" id="goldar" value="<?php echo $dataresult[0]->goldar; ?>" required>
            <div class="col"></div>
            <div class="col"></div>
            <div class="col"></div>
            <div class="col"></div>
